...
module embedded_system_mm_interconnect_0_addr_router_001_default_decode
  #(
...
module embedded_system_mm_interconnect_0_addr_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD6 = log2ceil(64'h400302a - 64'h4003028); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h400302a;
    ...
    embedded_system_mm_interconnect_0_addr_router_001_default_decode the_default_decode(
    ...
    // ( 0x4003028 .. 0x400302a )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h4003028   ) begin
